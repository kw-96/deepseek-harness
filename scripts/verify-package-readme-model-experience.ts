...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/experimental/web-desktop': { kind: 'none', reason: 'Native window shell that launches dsh web; it registers nothing model-facing.' },
  ...
  'packages/client/ui-codex-import': { kind: 'indirect', reason: 'The card triggers the Host codexImport.run/history verbs and toggles the autoSync settings field; dsh-session-import-codex owns the imported session logs a model later continues.' },
