...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceAttachSessionRequest: 'workspace.md',
  ...
  WorkspaceDetachSessionRequest: 'workspace.md',
  ...
  TerminalFollowFrame: 'terminal.md',
  CodexImportRun: 'session-import.md',
  CodexImportHistoryValue: 'session-import.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SessionKillJobRequest: 'remote request contract is owned by packages/api/session-controller/src/types.ts',
  SessionKillJobValue: 'remote response contract is owned by packages/api/session-controller/src/types.ts',
  CodexImportScanValue: 'remote response contract is owned by packages/session/session-import-codex/src/types.ts',
  CodexImportUndoValue: 'remote response contract is owned by packages/session/session-import-codex/src/types.ts',
