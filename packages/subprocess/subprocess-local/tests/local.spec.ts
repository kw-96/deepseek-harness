...
describe('LocalSubprocessRuntime', () => {
  ...
  it('disposal contains a spawn-failure rejection that races teardown', async () => {
    ...
    // that stops the bootstrap first settles as the requested termination â€”
  ...
  it('loading a second implementation throws (one processes service per context â€?cordis standard)', async () => {
    const ctx = new Context()
