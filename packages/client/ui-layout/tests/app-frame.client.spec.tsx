...
// 面板选择 stub：本地架构默认 null（会话视图），'main' 槽恒分发 'conversation'。
const usePanelInfo: AppFrameProps['usePanelInfo'] = selector => selector({ activePanelId: null })
// 资源地址 stub：AppFrame 自身不消费 useResource，按 GlobalStandardProps 补齐即可。
const useResource: AppFrameProps['useResource'] = (_address: string) =>
  ({ status: 'none', value: undefined, failure: undefined }) as never
