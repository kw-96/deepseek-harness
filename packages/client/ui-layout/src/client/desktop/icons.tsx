...
export function MinIcon() {
  return <svg width="12" height="12" viewBox="0 0 12 12" aria-hidden="true"><rect x="1" y="5.5" width="10" height="1" fill="currentColor" /></svg>
}
...
export function RestoreIcon() {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" aria-hidden="true">
      <path d="M1.5 4.5H4.5V10.5H1.5Z" fill="none" stroke="currentColor" strokeWidth="1" />
      <path d="M4.5 4.5V1.5H10.5V7.5H7.5" fill="none" stroke="currentColor" strokeWidth="1" />
    </svg>
  )
}
