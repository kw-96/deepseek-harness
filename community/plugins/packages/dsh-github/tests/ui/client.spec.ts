...
import { ConnectGitHubSection, PrStatusBar } from '../../src/ui/index.ts'
import type { GitHubUiRemote } from '../../src/ui/types.ts'
import { GITHUB_CONNECT_REMOTE } from '../../src/ui/client/contribution.ts'
import { apply, detectLocale, inject, name } from '../../src/ui/client/index.ts'
import { createBrowserShell } from '../../src/ui/client/shell.ts'
import { STYLE_MARKER, STYLE_TEXT, installStyles } from '../../src/ui/client/styles.ts'
