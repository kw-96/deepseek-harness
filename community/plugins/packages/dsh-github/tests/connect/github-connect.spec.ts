...
import GitHubRuntime, { GitHubError, type GitHubProvider } from '../../src/index.ts'
...
} from '../../src/connect/index.ts'
import * as connectInvariant from '../../src/connect/invariant.ts'
