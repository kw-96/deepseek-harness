...
export const COMMUNITY = {
  ...
  'dsh-workspace-rail': 'Codex 风格左侧导航栏：项目/工作区/会话三级浏览器（持久项目层、整理排序、自动归档与归档箱）、添加工作区弹窗、新建会话页项目选择器；底栏终端由 dsh-codex-shell 单独提供，未安装时「在终端中打开」自动禁用',
  'dsh-codex-shell': '宿主 bottom 行的多 tab 交互式终端：自带 pwsh/bash 标签、可跟随 Agent 的 terminal_* 会话，xterm 渲染；左侧导航栏由 dsh-workspace-rail 单独提供',
