    ...
    <>
      {anchor !== null && createPortal(
        <HeroProjectMenu
          ...
          onPick={onPick}
          onClose={onClose}
          onNewProject={() => { setCreating(true); onClose() }}
          t={t}
        />,
        document.body,
      )}
